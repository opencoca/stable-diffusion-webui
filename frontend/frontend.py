...
def draw_gradio_ui(opt, img2img=lambda x: x, txt2img=lambda x: x, imgproc=lambda x: x, txt2img_defaults={},
    ...
    """)
        ...
        gr.HTML("""
    <div id="90" style="max-width: 100%; font-size: 14px; text-align: center;" class="output-markdown gr-prose border-solid border border-gray-200 rounded gr-panel">
        <p>For help and advanced usage guides, visit the <a href="https://github.com/opencoca/stable-diffusion-webui/wiki" target="_blank">Project Wiki</a></p>
        ...
        If you would like to contribute to development or test bleeding edge builds, you can visit the <a href="https://github.com/opencoca/stable-diffusion-webui" target="_blank">developement repository</a>.</p>
    </div>
    """)
